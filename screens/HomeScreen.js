        ...
        <View style={styles.container}>
          ...
          <View style={styles.content}>
              ...
              <View style={styles.lowerButton}> 
                ...
                <ButtonHome iconName='book-medical' iconStyle={styles.iconStyle} iconSize={30} iconColor='#5FA59D' textButton='Mes commandes' textStyle={styles.textStyle} height={110} width={110}  backgroundColor='#FFFFFF'  color="#5FA59D" onPress={() => navigation.push('TabNavigator', {screen: 'Commandes'})} />
              </View>
          </View>
        </View>
    )}
